...
export type ServicesChangedHandler = (services: ServiceInfo[]) => void;
...
export interface ROS2BridgeApi {
    ...
    getROSParameter(name: string, opts?: {
        force?: boolean;
        timeoutMs?: number;
    }): Promise<unknown>;
    getROSParameters(names: string[], opts?: {
        timeoutMs?: number;
    }): Promise<Record<string, unknown>>;
    getAllROSParameters(opts?: {
        timeoutMs?: number;
    }): Promise<Record<string, unknown>>;
    ...
    callService<T = any>(name: string, request: any, opts?: {
        timeoutMs?: number;
    }): Promise<T>;
