...
export class EntityStateModel {
    ...
    public getYaw(): number | undefined {
        if (this.state.yaw !== undefined)
            return this.state.yaw;
        if (this.state.attitude?.yaw !== undefined)
            return this.state.attitude.yaw;
    ...
    public getNEDPosition(): {
        ...
        if (ned)
            return { x: ned.x, y: ned.y, z: ned.z };
        return undefined;
    }
    /**
    ...
    public getGlobalPosition(): {
        ...
        if (gpi)
            return { lat: gpi.lat, lon: gpi.lon, alt: gpi.alt };
        return undefined;
    }
    /**
    ...
    public hasValidPosition(): boolean {
        return ((this.state.local?.position !== undefined) ||
