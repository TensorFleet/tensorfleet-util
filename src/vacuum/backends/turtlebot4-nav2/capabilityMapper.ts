...
import { createUnsupportedCapabilities } from "../../capabilities.js";
import type { VacuumCommandName, VacuumCommandResult } from "../../commands.js";
import { unsupportedCommand } from "../../errors.js";
import {
...
export function mapTurtleBot4Nav2Capabilities(runtime: TurtleBot4Nav2RuntimeState): VacuumCapabilities {
  const capabilities = createUnsupportedCapabilities();
  const hasNavigateToPose = runtime.availableServices.includes(TURTLEBOT4_NAV2_SEND_GOAL_SERVICE);
  const hasCancelNavigation = runtime.availableServices.includes(TURTLEBOT4_NAV2_CANCEL_GOAL_SERVICE);
